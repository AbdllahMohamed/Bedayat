const Map<String, String> en = {
  ...
  'children': "children",
  'report_status': "Daily Report",
  'uncompleted': "uncompleted",
  'completed': "completed",
  'actions': "actions",
  'create_videos_photos': "create videos and photos",
  'create_daily_report': "create daily report",
  'add_report': 'add report',
  'child_status': 'child status',
  'attachments': 'attachments',
  'notes': 'notes',
  'child_mood_morning': 'child mood morning',
  'child_mood_noon': 'child mood noon',
  'child_mood_afternoon': 'child mood afternoon',
  'temperature_degree': 'temperature degree',
  'sleep_status': 'sleep status',
  'drink_status': 'drink status',
  ...
  'low': 'low',
  'activites': 'activites',
  'food_status_morning': 'food status breakfast',
  'food_status_noon': 'food status lunch',
  'food_status_afternoon': 'food status snack',
  'theـreportـisـbeingـsentـtoـtheـparent':
      'the report is being sent to the parent',
  'poe_and_pie': 'toilet',
  'reports': 'reports',
  'added_successfully': 'added successfully',
  'delete': 'delete  ',
  'select_the_content': 'select the content',
  'sleep_dration': 'sleep dration',
  'minutes': 'minutes',
  'degree': 'degree',
  'ُchild_status': 'ُchild status',
  'daily_report': 'daily report',
  'Gallery': 'Gallery',
  'activities': 'activities',
  'expires_at': 'Subscription ends :',
  'gallery': 'gallery',
  'download': 'download',
};
