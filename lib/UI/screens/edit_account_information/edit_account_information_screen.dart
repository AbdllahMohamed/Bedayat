        ...
        child: SingleChildScrollView(
          ...
          () => Column(
            ...
            children: [
              ...
              _editAccountController.initLoading.value
                        ...
                        children: [
                          ...
                          Padding(
                            ...
                            child: CustomeTextFormField(
                              ...
                              validator: (val) {
                                if (_editAccountController.newPassword.text !=
                                        "" ||
                          ...
                          Padding(
                            ...
                            child: CustomeTextFormField(
                              controller:
                                  _editAccountController.newPasswordConfirm,
                              validator: (val) {
                                if (_editAccountController.password.text !=
                                    "") {
                                  if (val.isEmpty) {
                          ...
                          _editAccountController.loadingProcess.value
